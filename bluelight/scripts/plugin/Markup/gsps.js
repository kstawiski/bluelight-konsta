...
function loadWriteGraphic() {
    ...
    var span = document.createElement("SPAN")
    span.innerHTML =
        `<img class="img GSPS" alt="Draw GSPS graphic annotations" id="drawGSPS" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/GraphicDraw.png" width="50" height="50" style="display:none;" >
        <img class="img GSPS" alt="Erase GSPS annotation graphics" id="eraseGSPS" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/b_Eraser.png" width="50" height="50" style="display:none;" >
        <img class="img GSPS" alt="Exit GSPS annotation mode" id="exitGSPS" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/exit.png" width="50" height="50" style="display:none;" >
        <img class="img GSPS" alt="Export as DICOM Grayscale Softcopy Presentation State" id="saveGSPS" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/download.png" width="50" height="50" style="display:none;" >`;

    addIconSpan(span);

    var span = document.createElement("SPAN")
    span.innerHTML =
        `<img class="innerimg GSPS" alt="Create DICOM Grayscale Presentation State (GSPS)" id="writeGSPS" onmouseover = "onElementOver(this);" onmouseleave = "onElementLeave();" src="../image/icon/lite/gsps_off.png" width="50" height="50">`;
